...
},{"./module/module1":2,"./module/module2":3,"./module/module3":4,"./module/module4":5,"jquery":6}],2:[function(require,module,exports){
'use strict';
...
exports.test1 = test1;
exports.test2 = test2;
var msg = exports.msg = 'module1 模块';

function test1() {
  console.log('module1', 'test1 方法');
}

function test2() {
  console.log('module1', 'test2 方法');
}
...
function print1() {
  console.log('module2', 'print1 方法');
}
function print2() {
  console.log('module2', 'print2 方法');
}
...
exports.default = function () {
  console.log('module3', 'module3 模块中暴露的方法。');
};
